...
env = environ.Env(
    ...
    ASSISTANT_CONFIRMATION_MAX_AGE=(int, 300),
)
...
OLLAMA_MODEL = env("OLLAMA_MODEL", default="llama3.2:latest")
OLLAMA_TIMEOUT_SECONDS = env("OLLAMA_TIMEOUT_SECONDS")
ASSISTANT_CONFIRMATION_MAX_AGE = env("ASSISTANT_CONFIRMATION_MAX_AGE")
